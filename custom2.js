...
$(document).ready(function($) {
    ...
    // Global height rule (applies to ALL devices)
    // if (windowHeight < 800) {
    //     offsetTrigger = 40;
 ...
 jQuery(document).ready(function($) {
    ...
    // }
      ...
      $('#footer-lead-section').appendTo('#lead_magnet_wrapper');
            ...
            $('.footer-card-container .card-footer button,.book-exploratory-button,.footer-session-section .want-ses-btn, #fractional-leadership-page .sqs-block-button-element--medium, #services-lead-magnet .sqs-block-button-element--medium, #excutive-function-coaching-bookcall .sqs-block-button-element--medium, #tudc-secvice-magnet .sqs-block-button-element--medium').on('click', function(e) {
                e.preventDefault();
